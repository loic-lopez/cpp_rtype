...
gui::Button_ex::Button_ex()
{

}

gui::Button_ex::Button_ex(std::string s, sf::Font& font, sf::Vector2f position, sf::Uint32 style)
{
    //set position
    m_position = position;
...
void gui::Button_ex::setSize(unsigned int size)
{
    m_fontSize = size;
...
void gui::Button_ex::setStyle(sf::Uint32 style)
{
    //set Button_ex style
    m_style = style;
...
void gui::Button_ex::setFont(sf::Font& font)
{
    m_text.setFont(font);
    m_shadow.setFont(font);
}

void gui::Button_ex::update(sf::Event& e, sf::RenderWindow& window)
{
...
void gui::Button_ex::draw(sf::RenderTarget& target,sf::RenderStates states) const
{
    switch(m_style)
    {
        case gui::style::none:
...
void gui::Button_ex::setBackgroundText(sf::Texture texture)
{
